      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="breadcrumb-text">
            ...
            <span>{{ ucfirst($selectedCategory->name) }}</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 products-sidebar-filter">
          <div class="filter-widget">
            <h4 class="fw-title text-uppercase">{{ $selectedCategory->name }}</h4>
          ...
          <div class="filter-widget">
            ...
            <div class="fw-tags">
              @forelse($brands as $brand)
                <a class="text-uppercase {{ $selectedBrandId == $brand->id ? 'bg-brand' : '' }}" href="" wire:click.prevent="$set('selectedBrandId', {{ $brand->id }})">{{ $brand->name }}</a>
              @empty
                No brand found!
              @endforelse
            </div>
